...
public class Demo {
	...
	public static void main(String[] args) {
		...
		hMap.put("banglore", new Student(1,"Ram","ram@gmail.com",200));
		hMap.put("chennai", new Student(2,"Ashish","Ashish@gmail.com",320));
		hMap.put("Bhopal", new Student(3,"Bhumesh","Bhumesh@gmail.com",100));
		hMap.put("Indore", new Student(4,"Punit","Punit@gmail.com",240));
		hMap.put("Delhi", new Student(5,"shyam","Shyam@gmail.com",300));
